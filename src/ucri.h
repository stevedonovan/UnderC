...
class XTemplateFun;
class XType;
typedef std::list<XType *> XTList;
typedef std::list<string> XStringList;
...
typedef std::list<XFunction *> XFunctions;
typedef std::list<XEntry *> XEntries;
...
class XModule;
typedef std::list<XModule *> XModules;
typedef std::list<XClass *> XClasses;
