...
inline int operator == (const string& s1, char *ps2)
{
  return s1.compare((const char*)ps2) == 0;
}
inline int operator != (const string& s1, const string& s2)
{
  return s1.compare(s2) != 0;
}
inline int operator != (const string& s1, const char*ps2)
{
  return s1.compare(ps2) != 0;
}
inline int operator <  (const string& s1, const string& s2)
{
  return s1.compare(s2) < 0;
