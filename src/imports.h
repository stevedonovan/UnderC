...
public:
  ...
  bool cpp_friendly()
  {
    return m_cpp_friendly;
  }
  void scheme_type(int st)
  {
    m_scheme_type = st;
  }
  int  scheme_type()
...
// overrideables
  virtual bool uses_stdmethod()
  {
    return false;
  }
  virtual bool pre_construct()
  {
    return true;
  }
  virtual bool ret_obj_popped()
  {
    return false;
  }
  virtual bool true_pass_by_value(Type)
  {
    return false;
  }
  virtual bool true_return_by_value(Type)
  {
    return false;
  }
  virtual void set_first_virtual_class(int) { }
  virtual int       vtable_full_size()
  {
    return m_vtable_size;
  }
  ...
  virtual bool      vtable_at_begining()
  {
    return true;
  }
